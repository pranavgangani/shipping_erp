            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                    	<h6 class="collapse-header">Manage Personnel:</h6>
                        <a class="collapse-item" href="add_crew.html">Add New Crew</a>
                        <a class="collapse-item" href="crew_list">CrewList</a>
                        
                        <h6 class="collapse-header">Custom Components:</h6>
                        <a class="collapse-item" href="personal_details.html">Personal</a>
                        <a class="collapse-item" href="address_details.html">Address</a>
                        <a class="collapse-item" href="nok_details.html">NOK</a>
                        <a class="collapse-item" href="bank_details.html">Bank Account</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="utilities-other.html">Licence</a>
