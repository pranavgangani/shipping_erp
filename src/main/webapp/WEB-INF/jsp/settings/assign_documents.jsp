							...
							<div class="row align-items-center justify-content-between pt-3">
								<div class="col-auto mb-3">
									<h1 class="page-header-title">
										...
										Assign Document Requirements to [${rank.name}]
									</h1>
								</div>
                                ...
                                <div class="card card-header-actions mb-4">
                                    ...
                                    <div class="card-body">
                                        <form>
											...
											<div class="row gx-3 mb-3">
												<div class="col-md-8">
													<label class="small mb-1" for="certName">Document Name</label> 
											...
											<div class="row gx-3 mb-3">
												<div class="col-md-8">
													<label class="small mb-1" for="certDesc">Document Description</label>
											...
											<!-- <div class="row gx-3 mb-3">
											 ...
											 <div class="row gx-3 mb-3">
                                                <div class="col-md-4">
                                                    <label class="small mb-1" for="certDuration">Document Validity</label> 
