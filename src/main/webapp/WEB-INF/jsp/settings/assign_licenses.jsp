				...
				<header
							...
							<div class="row align-items-center justify-content-between pt-3">
								<div class="col-auto mb-3">
									<h1 class="page-header-title">
										...
										Assign License Requirements to [${rank.name}]
									</h1>
								</div>
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <nav class="nav nav-borders">
							...
							<a class="nav-link active ms-0">Licenses</a>
                                ...
                                <div class="card card-header-actions mb-4">
                                    ...
                                    <div class="card-body">
                                        <form>
											...
											<div class="row gx-3 mb-3">
												<div class="col-md-8">
													<label class="small mb-1" for="certName">License Name</label> 
											...
											<div class="row gx-3 mb-3">
												<div class="col-md-8">
													<label class="small mb-1" for="certDesc">License Description</label>
											...
											<!-- <div class="row gx-3 mb-3">
											 ...
											 <div class="row gx-3 mb-3">
                                                <div class="col-md-4">
                                                    <label class="small mb-1" for="certDuration">License Validity</label> 
                                                    <input class="form-control" name="certDuration" type="text" placeholder="Enter License validity duration" value="" />
                                                </div>
                                                <div class="col-md-4">
											...
											<div class="row gx-3 mb-3">
                                                <div class="form-check mb-2">
                                                    ...
                                                    <label class="form-check-label" for="checkAccountGroups">Requires Bla Bla</label>
                                                </div>
                                                <div class="form-check mb-2">
                                                    <input class="form-check-input" id="checkProductUpdates" type="checkbox" checked />
                                                    <label class="form-check-label" for="checkProductUpdates">Requires Bla Bla</label>
                                                </div>
                                                <div class="form-check mb-2">
