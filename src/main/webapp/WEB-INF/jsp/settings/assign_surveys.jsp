				...
				<header
							...
							<div class="row align-items-center justify-content-between pt-3">
								<div class="col-auto mb-3">
									<h1 class="page-header-title">
										...
										Assign Survey Requirements to [${rank.name}]
									</h1>
								</div>
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <nav class="nav nav-borders">
							...
							<a class="nav-link active ms-0">Surveys</a>
                                ...
                                <div class="card card-header-actions mb-4">
                                    ...
                                    <div class="card-body">
                                        <form>
											...
											<div class="row gx-3 mb-3">
												<div class="col-md-8">
													<label class="small mb-1" for="certName">Survey Name</label> 
											...
											<div class="row gx-3 mb-3">
												<div class="col-md-8">
													<label class="small mb-1" for="certDesc">Survey Description</label>
											...
											<!-- <div class="row gx-3 mb-3">
											 ...
											 <div class="row gx-3 mb-3">
                                                <div class="col-md-4">
                                                    <label class="small mb-1" for="certDuration">Survey Validity</label> 
                                                    <input class="form-control" name="certDuration" type="text" placeholder="Enter Survey validity duration" value="" />
                                                </div>
                                                <div class="col-md-4">
